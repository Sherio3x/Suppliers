...
import 'package:supplier_invoice_app/notifiers/payment_list_notifier.dart';
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: Consumer<PaymentListNotifier>(
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: notifier.deleteState == PaymentListState.loading
                                          ? null
                                          : () async {
                                              await notifier.deletePayment(payment.id!); 
                                              if (notifier.deleteState == PaymentListState.error) {
                                                ScaffoldMessenger.of(context).showSnackBar(
                                                  SnackBar(content: Text('خطأ في حذف الدفع: ${notifier.errorMessage}')),
                                                );
                                              }
                                            },
                                    ),
